$(document).ready(function(){
            ...
            usuarios.forEach(usuario=>{
                ...
                <div class="row">
                    ...
                    <ul class="ml-4 mb-0 fa-ul text-muted">
                        ...
                        <li class="small"><span class="fa-li"><i class="fas fa-lg fa-map-marker-alt"></i></span> Localidad: ${usuario.localidad}</li>
    ...
    $('#form-crear').submit(e=>{
        ...
        $.post('../controlador/usuarioController.php',{nombre,apellido,edad,dni,sexo,pass,funcion},(response)=>{
            if(response=='add'){ 
                $('#add').hide('slow');
                $('#add').show(1000);
                $('#add').hide(2000);
