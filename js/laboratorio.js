$(document).ready(function(){
        ...
        $.post('../controlador/laboratorioController.php',{consulta,funcion},(response)=>{
            ...
            laboratorios.forEach(laboratorio => {
                template+=`
                    ...
                    <td>
                        <img src="${laboratorio.avatar}"class="img-fluid rounded-circle"style="width: 50px; height: 50px; object-fit: cover;">
                    </td>
    ...
    $(document).on('click','.borrar',(e)=>{
        ...
        swalWithBootstrapButtons.fire({
            ...
            confirmButtonText: "Si, eliminar laboratorio!",
            ...
            swalWithBootstrapButtons.fire(
                "Cancelado",
                'El laboratorio '+nombre+' no fué borrado',
                "error"
            )
